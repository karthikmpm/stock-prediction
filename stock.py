...
app.layout = html.Div(
    [
        html.Div(
            [
                # Navigation
                html.P("WELCOME TO STOCK VISUALIZATION", className="start"),
        
                html.Div([
                    html.P("Enter the stock code", className="kar"),
                    html.Div([
                        dcc.Input(id="dropdown_tickers", className="holder", type="text"),
